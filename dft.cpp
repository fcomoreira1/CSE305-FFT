...
void dft_baseline(const Complex *x, Complex *y, int n) {
    /*
...
void idft_baseline(const Complex *y, Complex *x, int n) {
    /*
...
void fft_general_template(const Complex *x, Complex *y, int n, 
    ...
    */
   	...
   	// Trivial case
	if (n <= 10) return dft_baseline(x, y, n);
...
void ifft_general_template(const Complex *y, Complex *x, int n, 
    ...
    */
   	...
   	// Trivial case
	if (n <= 10) return idft_baseline(y, x, n);
